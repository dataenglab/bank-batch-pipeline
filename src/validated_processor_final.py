...
class ValidatedBatchProcessor:
    ...
    def _import_existing_module(self):
        ...
        try:
            ...
            self.logger.warning(f"⚠️ Could not import existing processor module: {e}")
        ...
        try:
            ...
            for i in range(0, len(transactions), chunk_size):
                ...
                if success:
                    ...
                    self.logger.warning(f"⚠️ Failed to save chunk {i//chunk_size + 1}")
    ...
    def run_direct_comparison(self):
        ...
        print(f"\n🛡️  VALIDATION PROTECTION SUMMARY:")
        print("-" * 35)
