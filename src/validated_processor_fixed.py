...
class ValidatedBatchProcessor:
    ...
    def _import_existing_processor(self):
        ...
        try:
            ...
            self.logger.warning(f"⚠️ Could not import existing processor: {e}")
    ...
    def demo_comparison(self):
        ...
        print(f"   ⚠️  Would process invalid: {result_without['would_reject']} transactions")
    ...
    def _print_result(self, result):
        ...
        if result['success']:
            ...
            if result['rejected_count'] > 0:
                print(f"   🛡️  Protected: {result['rejected_count']} invalid transactions blocked")
        else:
